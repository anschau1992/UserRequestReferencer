...
public final class JavaCodeAnalyzer extends StopwordAnalyzerBase {
    ...
    public JavaCodeAnalyzer(CharArraySet stopWords) {
        super(stopWords);
    }

    public JavaCodeAnalyzer(Path stopwordsFile) throws IOException {
        this(loadStopwordSet(stopwordsFile));
    }

    public JavaCodeAnalyzer(Reader stopwords) throws IOException {
