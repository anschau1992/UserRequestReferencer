...
public class NewAnalyzer extends StopwordAnalyzerBase {
    ...
    public NewAnalyzer(CharArraySet stopWords) {
        super(stopWords);
    }

    public NewAnalyzer(Path stopwordsFile) throws IOException {
        this(loadStopwordSet(stopwordsFile));
    }

    public NewAnalyzer(Reader stopwords) throws IOException {
    ...
    protected Analyzer.TokenStreamComponents createComponents(String fieldName) {
        ...
        return new Analyzer.TokenStreamComponents((Tokenizer)source, tok5);
    }
